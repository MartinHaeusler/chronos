...
public interface EObjectQueryStepBuilder<S> extends QueryStepBuilder<S, EObject> {
	 ...
	 *            Whether or not subclasses are allowed. If <code>false</code>, any EObject that passes the filter must
	 ...
	 *
	 * @param eReference
	 *            The EReference to follow backwards. Must not be <code>null</code>.
	 *
	 * @return The query builder, for method chaining. Never <code>null</code>.
	 */
	 ...
	 *
	 * @param referenceName
	 *            The name of the reference to follow backwards. Must not be <code>null</code>.
	 *
	 * @return The query builder, for method chaining. Never <code>null</code>.
	 */

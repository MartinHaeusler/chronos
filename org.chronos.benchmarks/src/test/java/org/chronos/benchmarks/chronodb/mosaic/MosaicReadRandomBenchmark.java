package org.chronos.benchmarks.chronodb.mosaic;
...
import org.chronos.benchmarks.chronodb.read.FixedDistributionReadRandomBenchmark;
...
public class MosaicReadRandomBenchmark extends AllChronoDBBackendsTest {

	@Test
	@InstantiateChronosWith(property = ChronoDBConfiguration.CACHING_ENABLED, value = "true")
	@InstantiateChronosWith(property = ChronoDBConfiguration.CACHE_MAX_SIZE, value = "1_000_000")
	...
	private void writeVersionTimesXreadHeadTimesY(final int writes, final int reads) {
		...
		logInfo("");
		logInfo("End of run.");
		logInfo("End of run. Cache Statistics: " + db.getCache().getStatistics());
	}

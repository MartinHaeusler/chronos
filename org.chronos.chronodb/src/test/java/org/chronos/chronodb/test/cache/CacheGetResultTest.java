...
public class CacheGetResultTest extends ChronoDBUnitTest {
	...
	public void hashCodeAndEqualsWork() {
		CacheGetResult<String> hit = CacheGetResult.hit("180!!!");
		CacheGetResult<String> hit2 = CacheGetResult.hit("Bulls Eye!");
		CacheGetResult<String> hit3 = CacheGetResult.hit("Bulls Eye!");
		CacheGetResult<String> hit4 = CacheGetResult.hit(null);
		CacheGetResult<?> miss = CacheGetResult.miss();

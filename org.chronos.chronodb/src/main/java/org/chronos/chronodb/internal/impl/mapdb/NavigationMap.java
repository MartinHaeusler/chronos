...
public class NavigationMap {
	 ...
	 *            The transaction to work on. Must not be <code>null</code>, must be open.
	 * @param branchName
	 *            The name of the branch to get the keyspace-to-matrix-name map for. Must not be <code>null</code>, must refer to an existing branch.
	 *
	 ...
	 *
	 * <p>
	 * If there is a branch with the given name, then this method does nothing and returns immediately. Otherwise, a {@link ChronoDBBranchingException} is thrown.
	 *
	 * @param tx
	 *            The transaction to work on. Must not be <code>null</code>, must be open.
	 * @param branchName

...
public class DefaultTransactionConfiguration implements MutableTransactionConfiguration {
	...
	private boolean blindOverwriteProtectionEnabled;
	...
	public DefaultTransactionConfiguration() {
		...
		this.blindOverwriteProtectionEnabled = true;
	...
	@Override
	public void setBlindOverwriteProtectionEnabled(final boolean enabled) {
		this.assertNotFrozen();
		this.blindOverwriteProtectionEnabled = enabled;
	}

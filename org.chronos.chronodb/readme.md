...
ChronoDB is available from the Maven Central repository.
...
```groovy
compile group: 'com.github.martinhaeusler', name: 'org.chronos.chronodb', version: '0.7.3'
```
...
For the version history, please check the [https://github.com/MartinHaeusler/chronos](Main Page)
